...
option = {
    ...
    legend: {
        orient: 'vertical',
        x: 'left',
        data:['18-20','21-25','26-30','31-40','41-50','51以上'],
        textStyle: {color: '#fff'}
    },
    series: [
        {
            ...
            data:[
                {value:124, name:'18-20'},
                {value:434, name:'21-25'},
                {value:1356, name:'26-30'},
                {value:1423, name:'31-40'},
                {value:874, name:'41-50'},
                {value:112, name:'51以上'}
            ]
        }
    ]
